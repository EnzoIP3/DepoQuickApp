...
public class DeviceController : ControllerBase
{
    ...
    public IActionResult GetDevices([FromQuery] string? deviceName = null, [FromQuery] string? device = null, [FromQuery] string? model = null, [FromQuery] string? business = null, [FromQuery] int? page = 1,
        [FromQuery] int? pageSize = 20, [FromQuery]  string? deviceNameFilter = null, [FromQuery] int? modelNameFilter = null)
    {
        PagedData<BusinessLogic.Devices.Entities.Device> devices = _deviceService.GetDevices(page, pageSize, deviceNameFilter, modelNameFilter);
